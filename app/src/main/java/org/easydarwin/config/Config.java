...
//    public static final String DEFAULT_SERVER_IP = "cloud.easydarwin.org";
    public static final String DEFAULT_SERVER_IP = "video.qdsxkj.com";
    ...
    public static final String DEFAULT_STREAM_ID = "107700000088_11";
    public static final String PREF_NAME = "easy_pref";
    public static final String K_RESOLUTION = "k_resolution";


    public static final String SERVER_URL = "serverUrl";
    public static final String DEFAULT_SERVER_URL = "rtmp://www.easydss.com:10085/live/stream_"
